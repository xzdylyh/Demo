...
excelPath ="d:\demo\DATA\TestCase.xlsx"
...
class Excel(object):
    ...
    def OpenExcel(self,file='file.xls'):
        try:
            data = excel.open_workbook(self.excelPath)
            return  data
        except Exception,ex:
            print str(ex)
    ...
    def getExcelDataByName(self,start_col=0,sheet_name='Sheet1'):
        data = self.OpenExcel(self.excelPath)
...
if __name__=="__main__":
    print Excel(excelPath).getExcelDataByName(5)
